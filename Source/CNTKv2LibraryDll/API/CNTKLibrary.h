...
namespace CNTK
{
    ...
    public:
        ...
        ///
        template <typename ElementType>
        CNTK_API static ValuePtr CreateBatch(const NDShape& sampleShape, const std::vector<ElementType>& batch, const DeviceDescriptor& device, bool readOnly = false);
        ...
        ///
        template <typename ElementType>
        CNTK_API static ValuePtr CreateSequence(const NDShape& sampleShape, const std::vector<ElementType>& sequence, bool sequenceStartFlag, const DeviceDescriptor& device, bool readOnly = false);
        ...
        ///
        template <typename ElementType>
        static ValuePtr CreateSequence(const NDShape& sampleShape, const std::vector<ElementType>& sequence, const DeviceDescriptor& device, bool readOnly = false);
        ...
        ///
        template <typename ElementType>
        CNTK_API static ValuePtr CreateBatchOfSequences(const NDShape& sampleShape, const std::vector<std::vector<ElementType>>& basequence, const std::vector<bool>& sequenceStartFlags, const DeviceDescriptor& device, bool readOnly = false);
        ...
        ///
        template <typename ElementType>
        static ValuePtr CreateBatchOfSequences(const NDShape& sampleShape, const std::vector<std::vector<ElementType>>& sequence, const DeviceDescriptor& device, bool readOnly = false);
        ...
        ///
        template <typename ElementType>
        CNTK_API static ValuePtr CreateBatch(size_t dimension, const std::vector<size_t>& batch, const DeviceDescriptor& device, bool readOnly = false);
        ...
        ///
        template <typename ElementType>
        CNTK_API static ValuePtr CreateSequence(size_t dimension, const std::vector<size_t>& sequence, bool sequenceStartFlag, const DeviceDescriptor& device, bool readOnly = false);
        ...
        ///
        template <typename ElementType>
        static ValuePtr CreateSequence(size_t dimension, const std::vector<size_t>& sequence, const DeviceDescriptor& device, bool readOnly = false);
        ...
        ///
        template <typename ElementType>
        CNTK_API static ValuePtr CreateBatchOfSequences(size_t dimension, const std::vector<std::vector<size_t>>& batchOfSequences, const std::vector<bool>& sequenceStartFlags, const DeviceDescriptor& device, bool readOnly = false);
